    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('librarian', 'Librarian')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genres', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.genre')),
            ],
        ),
        migrations.CreateModel(
            name='BookReview',
